  ...
  return (
    ...
    <div className="flex gap-6 lg:px-8 flex-wrap md:flex-nowrap mt-14">
      <div className="flex p-6  h-[450px] rounded bg-black justify-between w-full text-center lg:text-left lg:w-1/2 bg-[url('/category1.png')] bg-cover bg-no-repeat bg-center">
          <div className="text-background w-full justify-items-center lg:justify-items-start content-end gap-2 mb-3">
            <h2
              className={`${inter.className} text-2xl text-background font-semibold mb-3 leading-snug text-center sm:text-left`}
            >
              PlayStation 5
            </h2>
            <p className="mt-1 w-3/5 text-sm">Black and White version of the PS5 coming out on sale.</p>
            <p className="font-medium flex items-center text-background gap-3 mb-5 mt-2 lg:-mb-3 underline underline-offset-4 justify-center sm:justify-start text-center sm:text-left">
              Shop Now
            </p>
          </div>
\      </div>
      ...
      <div className=" w-full lg:w-1/2 flex-wrap md:flex-nowrap">
        ...
        <div className="text-background w-full justify-items-center lg:justify-items-start content-end gap-2 mb-3">
        <h2
              className={`${inter.className} text-2xl text-background font-semibold mb-1 leading-snug text-center sm:text-left`}
            >
              Women’s Collections
            </h2>
            <p className="text-center lg:text-left w-3/5 text-sm">Featured woman collections that give you another vibe.</p>
            <p className="font-medium flex items-center text-background gap-3 mb-1 mt-1 lg:-mb-3 underline underline-offset-4 justify-center sm:justify-start text-center sm:text-left">
              Shop Now
            </p>
          </div>
        </div>
        ...
        <div className="flex h-[220px] gap-6 mt-6">
          ...
          <div className="text-background mt-20 xl:mt-24 gap-2">
          <h2
